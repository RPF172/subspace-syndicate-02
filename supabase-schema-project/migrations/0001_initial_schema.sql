-- filepath: /supabase-schema-project/supabase-schema-project/migrations/0001_initial_schema.sql
...
CREATE TABLE IF NOT EXISTS public.posts (
  ...
  CONSTRAINT fk_posts_user FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE
);

-- Create post_likes table for the like functionality
